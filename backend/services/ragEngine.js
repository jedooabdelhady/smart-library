...
class RAGEngine {
  ...
  async answer(question, bookId = null) {
    ...
    try {
      ...
      // حماية من التأخير: 90 ثانية كحد أقصى لكل استدعاء
...
3. تحقق من أرقام الصفحات وأسماء الكتب بدقة متناهية. ابحث في النص المرفق عن رقم الصفحة المحدد وتأكد أنه صحيح 100% ولا تنسب قولاً في صفحة لصفحة أخرى.
...
6. خذ وقتك وفكر ببطء لضمان الدقة المطلقة.
7. إذا كانت الإجابة الأولية كلها هلوسة وليس لها أصل، اكتب: "عذراً، لا توجد إجابة دقيقة في النصوص المرفقة."`
        },
        {
          role: 'user',
...
1. فكر خطوة بخطوة وببطء شديد. اقرأ كل النصوص أعلاه كلمة كلمة بتأنٍ. لا تتسرع أبداً. لديك الوقت الكافي.
2. أعد قراءة النصوص مرة ثانية وتأكد أنك لم تفوّت أي معلومة متعلقة بالسؤال. يجب عليك إيجاد الإجابة في هذه النصوص.
...
6. تأكد من إسناد كل معلومة إلى اسم الكتاب ورقم الصفحة الصحيح كما هو مذكور في النص. تأكد مرتين من رقم الصفحة قبل كتابته.
...
2. **اقرأ النصوص مرتين على الأقل وفكر ببطء**: في المرة الأولى افهم المحتوى العام، وفي المرة الثانية استخرج التفاصيل الدقيقة. خذ وقتك كاملاً ولا تتسرع في الإجابة.
3. **لا تتسرع بالاعتذار أبداً**: النصوص المرفقة غالباً تحتوي على الإجابة أو أجزاء منها. ابحث بجدية واجمع كل الأجزاء المتعلقة بالسؤال ورتبها. هذه كتب دينية شاملة ومن المستحيل أن لا تحتوي على أحكام أساسية كالوضوء أو الصلاة.
4. **التوثيق الدقيق**: كل معلومة تذكرها يجب أن ترافقها [اسم الكتاب، الصفحة X] مأخوذة من النص المرفق مباشرة. راجع رقم الصفحة مرتين قبل إضافته وتأكد أنه صحيح 100%. لا تخمن الأرقام.
5. **الشمولية**: اجمع كل الفوائد والأحكام والأقوال من جميع النصوص المرفقة، لا تكتفِ بنص واحد.
6. **التحقق الذاتي**: قبل إرسال إجابتك، فكر منطقياً وراجعها وتأكد أن كل معلومة فيها لها مصدر في النصوص المرفقة.
